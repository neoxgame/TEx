...
document.querySelector('#minimizex').onclick = function() {
    //minimize window
    remote.BrowserWindow.getFocusedWindow().setSize(630, 130);
};
...
function kill_browsing(text="Home")
{
    ...
    webview.stop();
    webview.setAttribute( 'httpreferrer', "http://neoxgame.top/");
    webview.setAttribute( 'useragent', "");
